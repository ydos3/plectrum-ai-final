...
import { MessageSquare, Image as ImageIcon, PlusCircle, Search, Menu, X, BookOpen, LogOut, User as UserIcon, Guitar, Globe, Video, HelpCircle, ChevronRight, ChevronLeft, Sparkles, Hand, Users, Gauge } from 'lucide-react';
        ...
        <aside className="hidden md:flex flex-col w-72 border-r border-[#5d4037] bg-[#2d1b15] shadow-2xl relative z-20 shrink-0">
          ...
          <nav className="flex-1 px-4 py-4 overflow-y-auto relative z-10 custom-scrollbar">
            ...
            <div className="mb-5">
              ...
              <NavItem view="TUNER" icon={Gauge} label="Tuner" soundIndex={0} />
